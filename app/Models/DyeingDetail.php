...
class DyeingDetail extends Model
{
    use SoftDeletes;
    protected $table = 'tbl_dyeing_detail';
    protected $guarded = [];
    ...
    {
        return $this->relDyeing()->value('validated_at');
    }
    ...
    public function relDyeing()
    {
        return $this->belongsTo(Dyeing::class, 'id_dyeing', 'id');
    }
    ...
    public function relLogStokKeluar()
    {
        return $this->belongsTo(LogStokPenerimaan::class, 'id_log_stok_keluar', 'id');
    }
}
