...
class PenerimaanSarungDetail extends Model
{
    use SoftDeletes, BelongsToThrough;
    protected $table = 'tbl_penerimaan_sarung_detail';
    protected $guarded = [];
    ...
    public function relPenerimaanSarung()
    {
        return $this->belongsTo(PenerimaanSarung::class, 'id_penerimaan_sarung', 'id');
    }
