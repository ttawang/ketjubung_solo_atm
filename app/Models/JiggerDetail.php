...
class JiggerDetail extends Model
{
    use SoftDeletes;
    protected $table = 'tbl_jigger_detail';
    protected $guarded = [];
    ...
    public function relJiggerDetail()
    {
        return $this->belongsTo(JiggerDetail::class, 'id_jigger_detail', 'id');
    }
