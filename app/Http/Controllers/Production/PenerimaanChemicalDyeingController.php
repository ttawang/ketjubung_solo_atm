...
class PenerimaanChemicalDyeingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $breadcumbs = [['nama' => 'Dyeing', 'link' => 'javascript:void(0)', 'active' => ''], ['nama' => 'Penerimaan Bahan Dyeing (Chemical)', 'link' => 'javascript:void(0)', 'active' => 'active']];
        $menuAssets = menuAssets('dyeing', 'penerimaan chemical dyeing', $breadcumbs, true, true, false, true);
        if (!$request->ajax()) return view('contents.production.penerimaan_chemical_dyeing.index', compact('menuAssets'));
        ...
        })->selectRaw('tbl_penerimaan_chemical.*, sub.count_detail')->orderBy('created_at', 'DESC');
    ...
    public function create(Request $request)
    {
        if ($request['isDetail'] == 'true') {
            ...
            $response['render'] = view('contents.production.penerimaan_chemical_dyeing.form-detail', compact('data', 'attr', 'idParent'))->render();
        } else {
            $response['render'] = view('contents.production.penerimaan_chemical_dyeing.form')->render();
        }
        return $response;
    }
    ...
    public function edit($id, Request $request)
    {
        if ($request['isDetail'] == 'true') {
            ...
            $response['render'] = view('contents.production.penerimaan_chemical_dyeing.form-detail', compact('id', 'data', 'attr', 'idParent'))->render();
        } else {
            ...
            $response['render'] = view('contents.production.penerimaan_chemical_dyeing.form', compact('data', 'id'))->render();
        }
        return $response;
    }
