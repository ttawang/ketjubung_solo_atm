...
class CreateResepDetailsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbl_resep_detail', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->softDeletes();
            $table->foreign('id_resep')->references('id')->on('tbl_resep')->onUpdate('restrict')->onDelete('restrict');
    ...
    {
        Schema::dropIfExists('tbl_resep_detail');
    }
}
