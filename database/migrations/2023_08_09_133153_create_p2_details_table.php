...
class CreateP2DetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_p2_detail', function (Blueprint $table) {
            ...
            $table->foreign('id_p2')->references('id')->on('tbl_p2')->onUpdate('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('tbl_p2_detail');
    }
}
