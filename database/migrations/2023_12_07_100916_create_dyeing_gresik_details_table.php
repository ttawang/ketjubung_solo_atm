...
class CreateDyeingGresikDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_dyeing_gresik_detail', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->date('tanggal')->nullable();
            $table->unsignedBigInteger('id_dyeing_gresik');
            ...
            $table->foreign('id_dyeing_gresik')->references('id')->on('tbl_dyeing_gresik')->onUpdate('restrict')->onDelete('restrict');
    ...
    {
        Schema::dropIfExists('tbl_dyeing_gresik_detail');
    }
}
