...
class CreateDetailPaletsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_palet_detail', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('id_palet');
            ...
            $table->timestamps();
            $table->softDeletes();
            $table->foreign('id_palet')->references('id')->on('tbl_palet')->onUpdate('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('tbl_palet_detail');
    }
}
