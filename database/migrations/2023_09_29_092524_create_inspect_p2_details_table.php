...
class CreateInspectP2DetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_inspect_p2_detail', function (Blueprint $table) {
            ...
            $table->foreign('id_p2')->references('id')->on('tbl_p2')->onUpdate('restrict')->onDelete('restrict');
    ...
    {
        Schema::dropIfExists('tbl_inspect_p2_detail');
    }
}
