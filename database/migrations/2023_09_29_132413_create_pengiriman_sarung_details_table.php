...
class CreatePengirimanSarungDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_pengiriman_sarung_detail', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('id_pengiriman_sarung');
            ...
            $table->timestamps();
            $table->softDeletes();
            $table->foreign('id_pengiriman_sarung')->references('id')->on('tbl_pengiriman_sarung')->onUpdate('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('tbl_pengiriman_sarung_detail');
    }
}
