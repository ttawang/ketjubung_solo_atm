...
class CreateDyeingJasaLuarDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_dyeing_jasa_luar_detail', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->date('tanggal')->nullable();
            $table->unsignedBigInteger('id_gudang');
            $table->unsignedBigInteger('id_dyeing_jasa_luar');
            ...
            $table->foreign('id_dyeing_jasa_luar')->references('id')->on('tbl_dyeing_jasa_luar')->onUpdate('restrict')->onDelete('restrict');
    ...
    {
        Schema::dropIfExists('tbl_dyeing_jasa_luar_detail');
    }
}
