...
class CreatePenomoranBeamRetursTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_beam_retur', function (Blueprint $table) {
            ...
            $table->string('code');
            $table->unsignedBigInteger('id_beam_retur')->nullable();
    ...
    {
        Schema::dropIfExists('penomoran_beam_returs');
    }
}
