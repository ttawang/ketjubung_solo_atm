...
class CreateFinishingCabutDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_finishing_cabut_detail', function (Blueprint $table) {
            ...
            $table->foreign('id_finishing_cabut')->references('id')->on('tbl_finishing_cabut')->onUpdate('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('tbl_finishing_cabut_detail');
    }
}
