...
class CreateInspectFinishingCabutDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_inspect_finishing_cabut_detail', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->date('tanggal')->nullable();
            $table->unsignedBigInteger('id_finishing_cabut');
            ...
            $table->foreign('id_finishing_cabut')->references('id')->on('tbl_finishing_cabut')->onUpdate('restrict')->onDelete('restrict');
    ...
    {
        Schema::dropIfExists('tbl_inspect_finishing_cabut_detail');
    }
}
