...
class CreateP1DetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_p1_detail', function (Blueprint $table) {
            ...
            $table->foreign('id_p1')->references('id')->on('tbl_p1')->onUpdate('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('tbl_p1_detail');
    }
}
