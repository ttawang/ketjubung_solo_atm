...
class CreateInspectDudulanDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_inspect_dudulan_detail', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->date('tanggal')->nullable();
            $table->unsignedBigInteger('id_dudulan');
            ...
            $table->foreign('id_dudulan')->references('id')->on('tbl_dudulan')->onUpdate('restrict')->onDelete('restrict');
    ...
    {
        Schema::dropIfExists('tbl_inspect_dudulan_detail');
    }
}
