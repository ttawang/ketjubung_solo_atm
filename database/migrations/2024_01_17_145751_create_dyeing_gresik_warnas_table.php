...
class CreateDyeingGresikWarnasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_dyeing_gresik_warna', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->date('tanggal');
            $table->unsignedBigInteger('id_warna');
            $table->unsignedBigInteger('id_barang');
            $table->unsignedBigInteger('id_satuan');
            $table->unsignedBigInteger('id_dyeing_gresik_detail');
            ...
            $table->foreign('id_dyeing_gresik_detail')->references('id')->on('tbl_dyeing_gresik_detail')->onUpdate('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('tbl_dyeing_gresik_warna');
    }
}
