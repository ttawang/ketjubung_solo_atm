...
class CreatePakanDetailTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_pakan_detail', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->softDeletes();
            $table->foreign('id_pakan')->references('id')->on('tbl_pakan')->onUpdate('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('tbl_pakan_detail');
    }
}
