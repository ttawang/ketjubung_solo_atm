...
class CreateDudulanDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_dudulan_detail', function (Blueprint $table) {
            ...
            $table->foreign('id_dudulan')->references('id')->on('tbl_dudulan')->onUpdate('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('tbl_dudulan_detail');
    }
}
