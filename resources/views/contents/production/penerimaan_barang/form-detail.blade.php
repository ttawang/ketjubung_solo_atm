<form
    ...
    <input type="hidden" name="input[id_penerimaan_barang]" value="{{ $idParent }}">
    <input type="hidden" name="id_log_stok_penerimaan" value="{{ $attr['idLogStokPenerimaan'] }}">
    <input type="hidden" name="tanggal" id="tanggal" value="{{ $data->tanggal_terima }}">
    <div class="form-group">
        <label>Barang</label>
        <select name="input[id_barang]" id="select_barang" data-placeholder="-- Pilih Barang --"
            data-route="{{ route('helper.getBarang') }}" data-id-penerimaan="{{ $idParent }}"
            class="form-control select2" required>
        </select>
    </div>

    {{-- <div id="wrapperField"></div> --}}
    ...
    <div class="form-group">
        ...
        {{-- <select name="input[id_satuan_1]" id="select_satuan_1" data-placeholder="-- Pilih Satuan Utama --"
            data-route="{{ route('helper.getSatuan') }}" class="form-control select2" required>
        </select> --}}
    </div>
    <div class="form-group">
