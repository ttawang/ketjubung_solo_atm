<title>{{ $judul }} - {{ $parent->nomor }}</title>
@php
    $style =
...
<table style="{{ $style }}">
    ...
    <tbody>
        <tr style="{{ $style }}">
            <td style="{{ $style }}" colspan="2">No. DPR:</td>
            <td style="{{ $style }}" colspan="4">{{ $parent->nomor }}</td>
            <td style="{{ $style }}" colspan="2">Tanggal </td>
            <td style="{{ $style }}" colspan="6">{{ tglIndo($parent->tanggal) }}</td>
            <td style="{{ $style }}" colspan="2">Berat @</td>
            <td style="{{ $style . $right }}" colspan="7">gram</td>
        </tr>
