...
<div class="form-group">
    <label>Overcone</label>
    <select id="select_barang" onchange="changeBarang($(this));" data-filter="1" data-filter-warna="YA"
        data-filter-dyeing="OVERCONE" data-id-dyeing="{{ $idParent }}"
