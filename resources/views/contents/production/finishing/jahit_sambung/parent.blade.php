<div class="form-group row">
    <div class="col-md-12">
        ...
        <button type="button" class="btn btn-secondary btn-sm waves-effect waves-classic float-left mr-2" onclick="cetak($(this))"><i class="icon md-print mr-2"></i> Cetak</button>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
...
<script type="text/javascript">
    $(function() {
        ...
        selectGudang(`jahit_sambung/get-gudang`);
        $('#barang').select2({
            dropdownParent: $('#modal-kelola'),
            width: '100%',
            allowClear: true,
        ...
        $.ajax({
            ...
            success: function(respon) {
                ...
                $(`#barang`).select2("trigger", "select", {
                    data: {
                        id: `${respon.id_mesin},${respon.id_barang},${respon.id_warna},${respon.id_motif},${respon.id_beam},${respon.id_songket},${respon.id_grade_awal},${respon.tanggal_potong}`,
                ...
                $('#id_grade_awal').val(respon.id_grade_awal);
                editbarang = `${respon.id_mesin},${respon.id_barang},${respon.id_warna},${respon.id_motif},${respon.id_beam},${respon.id_songket},${respon.id_grade},${respon.id_grade_awal},${respon.tanggal_potong}`;
    ...
    function getStok(data = {}) {
        $.ajax({
            url: `jahit_sambung/get-stok-barang`,
            type: 'GET',
            data: data,
            success: function(respon) {
                var id = $('#id').val();
                if (id == "") {
                    ...
                    var tempbarang = `${data.id_mesin},${data.id_barang},${data.id_warna},${data.id_motif},${data.id_beam},${data.id_songket},${data.id_grade},${data.id_grade_awal},${data.tanggal_potong}`;
    ...
    function cetak(this_) {
        ...
        Swal.fire({
            title: 'Cetak',
            html: `
                <input type="date" id="tgl" class="swal2-input">
            `,
            focusConfirm: false,
            preConfirm: () => {
                var tgl = document.getElementById('tgl').value;
                if (!tgl) {
                    Swal.showValidationMessage('Tanggal dan tipe cetak harus diisi');
                }
                return {
                    tgl: tgl,
                };
            ...
            if (result.isConfirmed) {
                var data = {
                    tgl: result.value.tgl,
                };
                var uri = `jahit_sambung/cetak`;
