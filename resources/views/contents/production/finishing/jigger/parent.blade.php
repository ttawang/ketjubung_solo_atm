...
<script type="text/javascript">
    $(function() {
        ...
        selectGudang(`jigger/get-gudang`);
        $('#barang').select2({
            dropdownParent: $('#modal-kelola'),
            width: '100%',
            allowClear: true,
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $(`#barang`).select2("trigger", "select", {
                    data: {
                        id: `${data.id_mesin},${data.id_barang},${data.id_warna},${data.id_motif},${data.id_beam},${data.id_songket},${data.id_grade_awal},${data.tanggal_potong}`,
                        text: `${data.id_mesin ? data.nama_mesin+' | ' : ''}${data.id_beam ? data.nomor_kikw + ' | ' : ''}${data.id_songket ? data.nomor_kiks + ' | ' : ''}${data.id_barang ? data.nama_barang+' | ':''}${data.id_warna ? data.nama_warna+' | ':''}${data.id_motif ? data.nama_motif+' | ':''}${data.id_grade_awal ? data.nama_grade_awal : ''}${data.tanggal_potong ? ' | '+data.tanggal_potong_text:''}`,
                        data: {
                            id_mesin: data.id_mesin,
                            id_barang: data.id_barang,
                            id_warna: data.id_warna,
