<div class="col-md-12">
    ...
    <div class="row text-center">
        <div class="col-md-6">
            <h3><span class="badge badge-outline badge-primary">No. SPK : {{ $data->nomor }}</span></h3>
        </div>
        <div class="col-md-6">
            <h3><span class="badge badge-outline badge-primary">Vendor : {{ $data->relSupplier->name }}</span></h3>
        </div>
    </div>
</div>
<br>
    ...
    <ul class="nav nav-tabs nav-tabs-line mr-25" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link active" data-toggle="tab" role="tab" data-tab="input" onclick="tab($(this))">
                <i class="icon md-format-valign-top mr-2"></i> Kirim
            </a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" data-toggle="tab" role="tab" data-tab="output" onclick="tab($(this))">
                <i class="icon md-format-valign-bottom mr-2"></i> Terima
            </a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" data-toggle="tab" role="tab" data-tab="hilang" onclick="tab($(this))">
                <i class="icon md-format-valign-bottom mr-2"></i> Hilang
            </a>
        </li>
    </ul>
...
<script type="text/javascript">
    ...
    function viewDetail(id = null, tipe = null) {
        var URL = '';
        URL = `finishing_cabut/view/detail/${id}/${tipe}`;
        $.ajax({
            url: URL,
            type: "get",
            dataType: "html",
