    ...
    <div class="modal-dialog modal-simple modal-center">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="simpan($(this))" data-proses="finishing_cabut">Simpan</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(function() {
        ...
        selectGudang(`finishing_cabut/get-gudang`, {
            tipe: tipe,
            id: id
        });
        $('#barang').select2({
            ...
            placeholder: "-- pilih --",
            ajax: {
                url: `finishing_cabut/get-barang`,
                data: function(d) {
                    d.tipe = tipe;
                    d.id = id;
    ...
    function tableDetail(id, tipe) {
        table = $('#table-detail').DataTable({
            ...
            searching: false,
            order: [],
            ajax: `finishing_cabut/table/${mode}/${id}/${tipe}`,
            ...
            columns: [{
                ...
                },
                {
                    ...
                    name: 'status',
                    render: (data) => {
                        let jumlahInspekting = data.jumlah_inspecting_fc || 0;
    ...
    function getStok(data = {}) {
        $.ajax({
            url: `finishing_cabut/get-stok-barang`,
            type: 'GET',
            data: data,
            success: function(respon) {
                var id = $('#id').val();
