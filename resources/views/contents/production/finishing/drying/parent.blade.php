...
<script type="text/javascript">
    $(function() {
        ...
        selectGudang(`drying/get-gudang`);
        $('#barang').select2({
            dropdownParent: $('#modal-kelola'),
            width: '100%',
            allowClear: true,
                    ...
                    return {
                        results: data.data.map(function(data) {
                            return {
                                ...
                                text: `${data.id_mesin ? data.nama_mesin+' | ' : ''}${data.id_beam ? data.nomor_kikw + ' | ' : ''}${data.id_songket ? data.nomor_kiks + ' | ' : ''}${data.id_barang ? data.nama_barang+' | ':''}${data.id_warna ? data.nama_warna+' | ':''}${data.id_motif ? data.nama_motif+' | ':''}${data.id_grade ? data.nama_grade : ''}${data.tanggal_potong ? ' | '+data.tanggal_potong_text:''}`,
                                data: {
            ...
            success: function(respon) {
                ...
                $(`#barang`).select2("trigger", "select", {
                    data: {
                        ...
                        text: `${respon.id_mesin ? respon.nama_mesin+' | ' : ''}${respon.id_beam ? respon.nomor_kikw + ' | ' : ''}${respon.id_songket ? respon.nomor_kiks + ' | ' : ''}${respon.id_barang ? respon.nama_barang+' | ':''}${respon.id_warna ? respon.nama_warna+' | ':''}${respon.id_motif ? respon.nama_motif+' | ':''}${respon.id_grade_awal ? respon.nama_grade_awal : ''}${respon.tanggal_potong ? ' | '+respon.tanggal_potong_text:''}`,
                        data: {
                ...
                $('#id_grade_awal').val(respon.id_grade_awal);
                editbarang =
                    `${respon.id_mesin},${respon.id_barang},${respon.id_warna},${respon.id_motif},${respon.id_beam},${respon.id_songket},${respon.id_grade},${respon.id_grade_awal},${respon.code},${respon.tanggal_potong}`;
        ...
        $.ajax({
            ...
            success: function(respon) {
                ...
                if (id == "") {
                    ...
                    var tempbarang =
                        `${data.id_mesin},${data.id_barang},${data.id_warna},${data.id_motif},${data.id_beam},${data.id_songket},${data.id_grade},${data.id_grade_awal},${data.code},${data.tanggal_potong}`;
