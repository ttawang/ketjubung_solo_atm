    ...
    <div class="modal-dialog modal-simple modal-center">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="simpan($(this))" data-proses="p2">Simpan</button>
            </div>
        </div>
    </div>
</div>
    ...
    function edit(this_) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                editbarang = `${data.id_mesin},${data.id_barang},${data.id_warna},${data.id_motif},${data.id_beam},${data.id_songket},${data.id_grade},${data.tanggal_potong}`;
