...
<div class="form-group row">
    <div class="col-md-12">
        ...
        <button type="button" class="btn btn-primary btn-sm waves-effect waves-classic float-left mr-2"
            data-model-inspect="InspectP1Detail" data-model-jasa-luar="P1Detail" data-table-parent="p1"
            data-route="inspect_p1/get-barang" onclick="retur($(this))"><i class="icon md-plus mr-2"></i> Tambah (Retur)
        </button>
...
<script type="text/javascript">
    $(function() {
        ...
        selectGudang(`inspect_p1/get-gudang`);
        $('#barang').select2({
            dropdownParent: $('#modal-kelola'),
            width: '100%',
            allowClear: true,
                ...
                processResults: function(data) {
                    return {
                        results: data.data.map(function(data) {
                            return {
                                id: `${data.id_p1},${data.id_mesin},${data.id_barang},${data.id_warna},${data.id_motif},${data.id_beam},${data.id_songket},${data.id_grade},${data.tanggal_potong}`,
        ...
        $.ajax({
            ...
            success: function(respon) {
                ...
                $(`#barang`).select2("trigger", "select", {
                    data: {
                        id: `${respon.id_p1},${respon.id_mesin},${respon.id_barang},${respon.id_warna},${respon.id_motif},${respon.id_beam},${respon.id_songket},${respon.id_grade_awal},${respon.tanggal_potong}`,
                ...
                $('#id_grade_awal').val(respon.id_grade_awal);
                editbarang =
                    `${respon.id_p1},${respon.id_mesin},${respon.id_barang},${respon.id_warna},${respon.id_motif},${respon.id_beam},${respon.id_songket},${respon.id_grade},${respon.id_grade_awal},${respon.tanggal_potong}`;
    ...
    function getStok(data = {}, isRetur = false) {
        $.ajax({
            url: `inspect_p1/get-stok-barang`,
            type: 'GET',
            data: data,
            success: function(respon) {
                var id = data.id;
