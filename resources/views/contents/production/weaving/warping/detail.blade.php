<div class="col-md-12">
    ...
    <div class="row text-center">
        {{-- <div class="col-md-6">
            <h3><span class="badge badge-outline badge-primary">No. Warping : {{ $data->no_warping }}</span></h3>
        </div> --}}
        <div class="col-md-12">
            <h3><span class="badge badge-outline badge-primary">No. Mesin Warping : {{ $data->relMesin->name }}</span></h3>
        </div>
    </div>
</div>
<br>
<div class="nav-tabs-horizontal" data-plugin="tabs">
    <ul class="nav nav-tabs nav-tabs-line mr-25" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link" data-toggle="tab" role="tab" data-tab="sisa" onclick="tab($(this))">
                <i class="icon md-format-valign-top mr-2"></i> Sisa
            </a>
        </li>
    </ul>
...
<script type="text/javascript">
    ...
    function viewDetail(id = null, tipe = null) {
        var URL = '';
        URL = `warping/view/detail/${id}/${tipe}`;
        $.ajax({
            url: URL,
            type: "get",
            dataType: "html",
