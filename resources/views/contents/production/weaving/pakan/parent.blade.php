    ...
    <div class="modal-dialog modal-simple modal-center">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="btnSubmit" onclick="simpanNota($(this))">Simpan</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    function closeModal() {
        ...
        $('#id').val('');
        $('#tanggal').val(`{{ date('Y-m-d') }}`).prop('readonly', false);
        $('#nomor').val('');
        $('#catatan').val('');
    }

    function tambah(this_) {
        $('#btnSubmit').attr('onclick', 'simpanNota($(this))');
    ...
    function edit(this_) {
        ...
        $('#modal-kelola').modal('show');
        $('#btnSubmit').attr('onclick', 'simpan($(this))');
        var id = this_.data('id');
        $.get(`pakan/get-data/${id}/${mode}`, function(data) {
            $('#id').val(data.id);
