...
@section('content')
    <div class="panel panel-primary panel-line">
        ...
        <div class="panel-body" id="mainWrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-bordered table-hover table-striped" cellspacing="0" id="tableCucuk">
                        <thead>
                            <tr>
                                <th width="30px">No</th>
                                <th>Tanggal</th>
...
@section('js')
    <script type="text/javascript">
        $(document).ready(function() {
            tableAjax = $('#tableCucuk').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                autoWidth: false,
        ...
        function initDetailTable(id, data) {
            ...
            tableAjaxDetail = $('#tableCucukDetail').DataTable({
                processing: true,
                serverSide: true,
                autoWidth: false,
                retrieve: true,
