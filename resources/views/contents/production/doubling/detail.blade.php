    ...
    <div class="panel-title form-group row">
        <div class="col-md-12">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-6">
                    <h3>
                        <span class="badge badge-outline badge-primary">Vendor :
                            {{ $data->relSupplier()->value('name') }}
                        </span>
                    </h3>
                </div>
            </div>
        ...
        <div class="tab-content py-20">
            <div class="tab-pane active" id="tabKirim" role="tabpanel">
                <div class="form-group row">
                    <div class="col-md-12">
                        {!! App\Helpers\Template::tools($tools, $id, 'Kirim', ['status' => 'KIRIM']) !!}
                    </div>
                </div>
            ...
            <div class="tab-pane" id="tabTerima" role="tabpanel">
                <div class="form-group row">
                    <div class="col-md-12">
                        {!! App\Helpers\Template::tools($tools, $id, 'Terima', ['status' => 'TERIMA']) !!}
                    </div>
                </div>
