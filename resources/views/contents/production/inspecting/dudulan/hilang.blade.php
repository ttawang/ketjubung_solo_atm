                ...
                processResults: function(data) {
                    return {
                        results: data.data.map(function(data) {
                            return {
                                id: data.id,
                                text: `${data.id_mesin ? data.nama_mesin+' | ' : ''}${data.id_beam ? data.nomor_kikw + ' | ' : ''}${data.id_songket ? data.nomor_kiks + ' | ' : ''}${data.nama_barang} | ${data.nama_warna} | ${data.nama_motif}${data.id_grade ? ' | '+data.nama_grade : ''}${data.tanggal_potong ? ' | '+data.tanggal_potong_text : ''}`,
                                data: {
        ...
        $.ajax({
            ...
            success: function(respon) {
                ...
                $(`#barang`).select2("trigger", "select", {
                    data: {
                        id: respon.id_parent,
                        text: `${respon.id_mesin ? respon.nama_mesin+' | ' : ''}${respon.id_beam ? respon.nomor_kikw + ' | ' : ''}${respon.id_songket ? respon.nomor_kiks + ' | ' : ''}${respon.nama_barang} | ${respon.nama_warna} | ${respon.nama_motif}${respon.id_grade ? ' | '+respon.nama_grade : ''}${respon.tanggal_potong ? ' | '+respon.tanggal_potong_text : ''}`,
                        data: {
        ...
        $.ajax({
            ...
            success: function(respon) {
                ...
                if (id == "") {
                    ...
                    var tempbarang =
                        `${data.id_mesin},${data.id_barang},${data.id_warna},${data.id_motif},${data.id_beam},${data.id_songket},${respon.id_grade},${data.tanggal_potong}`;
