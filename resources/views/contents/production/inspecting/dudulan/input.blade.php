            ...
            <div class="modal-body" style="padding-bottom: 20px;">
                <form class="form-horizontal" id="form" action="" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" id="grade" name="id_grade">
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        selectGudang(`dudulan/get-gudang`, {
            tipe: tipe,
            id: id
        });
        $('#barang').select2({
                ...
                processResults: function(data) {
                    return {
                        results: data.data.map(function(data) {
                            return {
                                id: `${data.id_mesin},${data.id_barang},${data.id_warna},${data.id_motif},${data.id_beam},${data.id_songket},${data.tanggal_potong}`,
                                text: `${data.nama_mesin ? data.nama_mesin+' | ' : ''}${data.id_beam ? data.nomor_kikw + ' | ' : ''}${data.id_songket ? data.nomor_kiks + ' | ' : ''}${data.nama_barang} | ${data.nama_warna} | ${data.nama_motif}${data.tanggal_potong ? ' | ' + data.tanggal_potong_text : ''}`,
                                data: {
    ...
    function tableDetail(id, tipe) {
        table = $('#table-detail').DataTable({
            ...
            searching: false,
            order: [],
            ajax: `dudulan/table/${mode}/${id}/${tipe}`,
    ...
    function getBarang(this_) {
        ...
        if (val) {
            ...
            $('#tanggal_potong').val(val.data.tanggal_potong);
        ...
        $.ajax({
            ...
            success: function(respon) {
                ...
                $(`#barang`).select2("trigger", "select", {
                    data: {
                        id: `${respon.id_mesin},${respon.id_barang},${respon.id_warna},${respon.id_motif},${respon.id_beam},${respon.id_songket},${respon.id_tanggal_potong}`,
                        text: `${respon.id_mesin ? respon.nama_mesin+' | ' : ''}${respon.id_beam ? respon.nomor_kikw + ' | ' : ''}${respon.id_songket ? respon.nomor_kiks + ' | ' : ''}${respon.nama_barang} | ${respon.nama_warna} | ${respon.nama_motif}${respon.tanggal_potong ? ' | '+ respon.tanggal_potong_text : ''}`,
                        data: {
                ...
                editbarang =
                    `${respon.id_mesin},${respon.id_barang},${respon.id_warna},${respon.id_motif},${respon.id_beam},${respon.id_songket},${respon.tanggal_potong}`;
        ...
        $.ajax({
            ...
            success: function(respon) {
                ...
                if (id == "") {
                    ...
                    var tempbarang =
                        `${data.id_mesin},${data.id_barang},${data.id_warna},${data.id_motif},${data.id_beam},${data.id_songket},${data.tanggal_potong}`;
