<div class="panel-body">
    <div class="form-group row">
        <div class="col-md-12">
            <h3 class="text-center">
                <span class="badge badge-outline badge-default"><i class="icon md-accounts mr-2"></i>
                    {{ $data->name ?? '' }}
                </span>
            </h3>
        </div>
    ...
    <div class="form-group row">
        <div class="col-md-12">
            <button type="button" data-id="{{ $data->id }}"
                ...
                data-route="{{ route('database.group.create') }}" onclick="addForm($(this), true);"><i
                    class="icon md-plus mr-2"></i> Tambah Pekerja</button>
    ...
    <div class="row">
        <div class="col-md-12">
            <table id="tableGroupDetail" class="table table-bordered table-striped" style="width: 100%;">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Pekerja</th>
